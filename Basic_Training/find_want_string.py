'''
문제 출처: https://school.programmers.co.kr/learn/courses/30/lessons/181878

원하는 문자열 찾기

문제 설명
알파벳으로 이루어진 문자열 myString과 pat이 주어집니다. myString의 연속된 부분 문자열 중 pat이 존재하면 1을 
...
def solution(myString, pat):
    answer = 0
    new_s, new_p = myString.upper(), pat.upper()
    if new_p in new_s:
        answer = 1
    return answer